...
export type InventorySource = {id:string;name:string;kind:string;base_url:string;enabled:boolean;last_sync_at:string|null;last_sync_status:string;last_sync_error:string|null;device_count:number;importable_count:number;imported_count:number};
