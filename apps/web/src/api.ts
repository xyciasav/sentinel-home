...
export type NetworkAsset = {id:string;name:string;address:string|null;mac_address:string|null;status:string;sources:string[];observations:number;linked:boolean;last_seen_at:string|null};
