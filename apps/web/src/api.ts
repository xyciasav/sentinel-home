...
export type RemediationPlan = {id:string;finding_id:string;agent_id:string;package_name:string;installed_version:string;target_version:string;operation:string;status:"draft"|"approved"|"queued"|"running"|"completed"|"failed";created_at:string;approved_at:string|null};
