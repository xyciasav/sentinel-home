...
export type ApplicationIntegration = {id:string;name:string;kind:"sonarr"|"radarr"|"sabnzbd";base_url:string;enabled:boolean;last_sync_at:string|null;last_sync_status:string;last_sync_error:string|null;latest:ApplicationSnapshot|null;history:ApplicationSnapshot[]};
