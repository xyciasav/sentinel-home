...
import { ActionItem, Agent, api, ContainerInstance, Device, DiscoveryRun, Incident, InventorySource, NetworkChange, Notification, OverviewReport, ServiceMonitor, StorageScanJob, StorageTarget, User, VulnerabilityFinding } from "./api";
...
type Page = "overview" | "devices" | "agents" | "containers" | "sources" | "discovery" | "changes" | "storage" | "services" | "incidents" | "notifications" | "vulnerabilities" | "actions" | "reports";

const assetPages:Page[]=["devices","agents","containers","sources","discovery","changes","storage"];
