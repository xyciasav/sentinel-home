...
import { api, Device, DiscoveryRun, Incident, Notification, ServiceMonitor, User } from "./api";
...
export function App() {
  ...
  const [page, setPage] = useState<"overview" | "devices" | "services" | "incidents" | "notifications" | "discovery">("overview");
